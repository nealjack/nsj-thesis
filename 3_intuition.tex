...
For energy harvesting, this would represent changing a workload to only require a percentage of the expected available harvestable power.
We can model this margin to identify the impact of over-provisioning energy harvesting income for a given workload. 

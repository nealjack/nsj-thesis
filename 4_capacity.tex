...
\begin{definefigure*}{fig:primary}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[\linewidth]{figs/capacity/primary/sense_and_send_life_vs_sec_size}
    \caption{Periodic Application}
    \label{fig:primary:sensesec}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[\linewidth]{figs/capacity/primary/door_occu_life_vs_sec_size}
...
Worse, batteryless system failures are difficult to detect %and mitigate

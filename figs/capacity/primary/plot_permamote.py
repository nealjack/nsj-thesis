...
def plot_lines(plt):
    ...
    ls.append(lines.Line2D([24, 24], [-2, 50], lw=2, color = 'C3', clip_on=False))
    plt.text(30, 25, 'Permamote', weight='bold', color = 'C3', rotation = 'vertical', horizontalalignment='center')
    for l in ls:
        ax.add_line(l)
    return text

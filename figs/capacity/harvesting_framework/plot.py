...
#infeasible
plt.plot([0, 0.05],[0.9,0.1],color='black',linewidth=0.5)
plt.plot([0.05, 0.05666],[0.1,0],color='black',linewidth=0.5,linestyle='--')
...
art = plt.plot([0.05666, 0.05666],[-0.007,0.007],color='black',linewidth=1)
art[0].set_clip_on(False)
plt.text(0.20,0.03,'Infeasible',multialignment='center')
#plt.text(0.005,0.32,'Infeasible',multialignment='center',rotation=90)

#state retention
plt.plot([0, 0.5],[0.9,0.1],color='black',linewidth=0.5,zorder=2000)
plt.plot([0.5, 0.5666],[0.1,0],color='black',linewidth=0.5,linestyle='--')
plt.fill([0.05,0,0.5],[0.1,0.9,0.1],color=t10[blue],alpha=0.5,linewidth=0)
plt.text(0.505,-0.13,'energy of\nlargest non-atomic\noperation',multialignment='center',fontsize=10)
art = plt.plot([0.5666, 0.5666],[-0.007,0.007],color='black',linewidth=1)
art[0].set_clip_on(False)
plt.text(0.1,0.38,'Checkpointing\nrequired',multialignment='center',zorder=2000)
...
t= plt.text(0.55,0.22,'Hysteresis management less helpful',multialignment='left',zorder=2000)
#t.set_bbox(dict(facecolor='#9f9f9f', alpha=0.5, edgecolor=None,linewidth=0,pad=0.1))
#plt.text(0.33,0.6,'Checkpointing not required\nHysteresis management marginally helpful',multialignment='center',zorder=2000)
plt.text(0.4,0.6,'Checkpointing not required',multialignment='center',zorder=2000)
...
path = Path([[0.0452,0.2],[0.0266,0.4],[1,0.4],[1,0.2]])
...
im = plt.imshow(Z, interpolation='bilinear', origin='lower', cmap=my_cmap, clip_path=patch, clip_on=True, aspect='auto',extent=[0.026,1,0.2,0.4],zorder=1000)

...
the minimum sufficient capacity should be between 3--\num{6E6}x the workload power, or  


A 20\ssi{\milli\Ah} (48\ssi{\milli\Wh}) LTO battery is charged by an 10.9\ssi{\centi\meter\squared} amorphous
...
In some cases, the available harvestable power may be insufficient to operate in an energy neutral fashion.
This justifies the choice for a reliable, non-rechargeable backup energy source.
...
\subsection{Summary}
The design of \name encapsulates the design conclusions from \cref{chap:intuition}, \cref{chap:capacity}, and \cref{chap:battery} to develop a long-lived and highly available solution for illuminance sensing.

...
On average, this income power can provide sufficient average power to support various frequencies of the sense and send workload.
...
the minimum sufficient capacity should be \num{3.4E2} times the average income power. This is if we assume an income distribution similar to the EnHANTs Setup D and a workload margin of 80\% of the expected income power\footnote{100\ssi{\micro\watt} represents about an 80\% margin over the 24.5\ssi{\micro\watt} workload}.
...
The simulation slightly underestimates the heuristic-determined energy capacity.
...
Considering the sizing factor for income resembling the distribution of Setup D, determined in \cref{sec:intuition:margin}, we should expect a minimum sufficient capacity that is \num{3.4E2} times the lower end of income power. 
This corresponds to an energy capacity of 4182\ssi{\milli\Wh}. 
The 33\ssi{\milli\farad} supercapacitor on Camaroptera only provides 41\ssi{\micro\Wh}, or five orders of magnitude less than the energy capacity we predict.
...
Camaroptera was implemented with an energy capacity that was sized arbitrarily to support its most energy intensive task. This arbitrary design decision results in a minimally feasible design that is fails to fully capture and utilize the 
